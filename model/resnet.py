...
def resnet18(n_class: int=1000, **kwargs: Any) -> ResNet:
    model = ResNet([2, 2, 2, 2], _BasicBlock, num_classes=n_class, **kwargs)
    return model


def resnet34(n_class: int=1000, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 6, 3], _BasicBlock, num_classes=n_class, **kwargs)
    return model


def resnet50(n_class: int=1000, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 6, 3], _Bottleneck, num_classes=n_class, **kwargs)
    return model


def resnet101(n_class: int=1000, **kwargs: Any) -> ResNet:
    model = ResNet([3, 4, 23, 3], _Bottleneck, num_classes=n_class, **kwargs)
    return model


def resnet152(n_class: int=1000, **kwargs: Any) -> ResNet:
    model = ResNet([3, 8, 36, 3], _Bottleneck, num_classes=n_class, **kwargs)
    return model
